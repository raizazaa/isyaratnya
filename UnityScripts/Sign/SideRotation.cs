...
namespace Sign
{
    public class SideRotation
    {
        ...
        private void FingersRotation()
        {
            ...
            _thumb1 = LookRotateTargetSides(_frameData.Thumb1(), _frameData.HandFacing());
            _thumb2 = LookRotateTargetSides(_frameData.Thumb2(), _frameData.HandFacing());
            _thumb3 = LookRotateTargetSides(_frameData.Thumb3(), _frameData.HandFacing());
        }
        ...
        private Quaternion LookRotateTargetSides(Vector3 direction, Vector3 sides)
        {
            var right = BoolSide() ? -direction : direction;
            var forward = sides;
